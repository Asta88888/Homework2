...
def test_product_lawn_grass_init(lawn_grass1):
...
def test_product_lawn_grass_init2(lawn_grass2):
...
def test_product_lawn_grass_common_price(lawn_grass1, lawn_grass2):
    assert lawn_grass1 + lawn_grass2 == 16750.0


def test_product_lawn_grass_common_price_invalid(lawn_grass1, lawn_grass2):
